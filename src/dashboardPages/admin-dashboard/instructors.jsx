            ...
            <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col justify-start items-start">
                  ...
                  <p className="text-sm text-gray-700 bg-gray-100 py-2 px-6 rounded-xl w-auto ">{selectedInstructor.position}</p>
                </div>

                {/* Delete Button */}
                <button className="w-full md:w-auto bg-[#C77373] text-white py-2 px-6 cursor-pointer text-sm rounded-lg font-semibold mt-6">Delete</button>
              </div>
            </div>
          </div>
        </div>
