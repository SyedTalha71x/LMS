  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 p-4 bg-white rounded-lg">
        ...
        <div className="flex justify-between items-center mt-10 mb-2">
          <div className="flex gap-2 items-center">
            ...
            <div className="flex space-x-2">
              <button onClick={prevWeek} className="p-1 rounded-md bg-gray-100">
                <ChevronLeft className="h-4 w-4" />
              </button>
              <button onClick={nextWeek} className="p-1 rounded-md bg-gray-100">
                            ...
                            >
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <div className="text-xs mt-1">{event.days}</div>
                                ...
                                {event.participants > 0 && (
                                  <div className="flex -space-x-1">
                                    {Array.from({
                                      ...
                                      <div key={i} className="h-5 w-5 rounded-full bg-gray-300 border-2 border-white" />
                                    ))}
                                  </div>
                                )}
                              </div>
      ...
      <div className="w-full lg:w-1/4">
        ...
        <div className="bg-gray-50 p-4 mt-10 rounded-md">
          <div className="flex justify-between items-center mb-4">
